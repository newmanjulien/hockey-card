...
function toPromptCanvasDocuments(route: DemoRouteRecord): readonly PromptCanvasDocument[] {
...
function createPromptInitialValue(route: DemoRouteRecord) {
...
export function createPromptCanvasRouteContent(routeId: DemoRouteId): PromptCanvasRouteContent {
