<script lang="ts">
	...
	import PromptCanvasDocumentSection from '$lib/canvas/PromptCanvasDocumentSection.svelte';
	import type { PromptCanvasDocument, PromptCanvasTrainer } from '$lib/canvas/types';
